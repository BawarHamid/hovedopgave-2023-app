...
const DishCard: React.FC<DishCardProps> = ({ dishSrc, dishTitle }) => {
  return (
    <IonCard className="mx-6 rounded-xl">
      ...
      <div className="flex justify-center mt-[-70px] w-full h-10 bg-white bg-opacity-60 absolute items-center">
